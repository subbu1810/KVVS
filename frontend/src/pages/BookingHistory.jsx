        ...
        <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                ...
                <div className="space-y-4 flex-grow">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="px-2 py-0.5 rounded border border-slate-800 bg-slate-100 text-slate-450 font-mono text-[10px]">
                      {book.Product?.kw_capacity} KW
                    </span>

                    {/* Status Pill badges */}
                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-orbitron font-bold uppercase tracking-wider ${book.status === 'confirmed'
                  ...
                  {book.status === 'confirmed' && book.Pass && (
                    <div className="flex items-center space-x-3 w-full md:w-auto">
                      <button
                        ...
                        className="flex-1 md:flex-none px-4 py-2 bg-slate-100 border border-slate-800 rounded font-orbitron text-xs text-[#00f2fe] hover:bg-slate-800 transition-colors flex items-center justify-center space-x-1.5"
                      >
          ...
          {bookings.length === 0 && (
            <div className="text-center py-20 border border-dashed border-slate-800 rounded-2xl glass-panel">
              ...
              <h3 className="font-orbitron text-base text-black mb-2">NO RESERVED PASSES FOUND</h3>
        ...
        {selectedPass && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-sm bg-slate-50 border border-cyan-500/40 glow-shadow-cyan rounded-2xl p-6 sm:p-8 shadow-2xl z-10 text-center"
            >
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  onClick={() => setSelectedPass(null)}
                  className="p-1 rounded hover:bg-slate-100 border border-slate-800 text-black hover:text-black"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="text-left text-xs bg-slate-100/50 border border-slate-850 p-4 rounded-xl space-y-2 mb-6">
                <p>Security Code: <span className="text-black font-mono font-bold float-right select-all">{selectedPass.pass_id}</span></p>
